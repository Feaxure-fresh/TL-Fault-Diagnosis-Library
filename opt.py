...
def parse_args():
    ...
    parser.add_argument('--source_name', type=list, default=['CWRU'], help='the name of the source data')
    ...
    parser.add_argument('--tradeoff', type=list, default=[1., 1., 1.], help='coefficients of loss')
