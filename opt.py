...
def parse_args():
    ...
    # basic parameters
    parser.add_argument('--model_name', type=str, default='MSSA',
                        help='the name of the model (must in ./models directory)')
    parser.add_argument('--source_name', type=list, default=['CWRU_1'],
                        help='the name of the source data (select different conditions of a dataset with dataset_num, such as CWRU_0)')
    parser.add_argument('--target_name', type=str, default='CWRU_3',
