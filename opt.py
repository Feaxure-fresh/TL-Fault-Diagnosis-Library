...
def parse_args():
    ...
    parser.add_argument('--source_name', type=list, default=['CWRU_2'], help='the name of the source data')
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='./Ckpt/CWRU', help='the directory to save the model')
