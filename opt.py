...
def parse_args():
    ...
    # basic parameters
    parser.add_argument('--model_name', type=str, default='CADG', help='the name of the model')
    parser.add_argument('--source_name', type=list, default=['CWRU_1'], help='the name of the source data')
    parser.add_argument('--target_name', type=str, default='CWRU_0', help='the name of the target data')
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='./Ckpt/src1', help='the directory to save the model')
    ...
    parser.add_argument('--tradeoff', type=list, default=[1, 'exp', 1], help='coefficients of loss')
