...
def parse_args():
    ...
    # basic parameters
    parser.add_argument('--model_name', type=str, default='Man_Moe', help='the name of the model')
    parser.add_argument('--source_name', type=list, default=['IMS'], help='the name of the source data')
    parser.add_argument('--target_name', type=str, default='CWRU', help='the name of the target data')
    ...
    parser.add_argument('--checkpoint_dir', type=str, default='./Ckpt/cross_data', help='the directory to save the model')
    parser.add_argument('--batch_size', type=int, default=64, help='batchsize of the training process')
    parser.add_argument('--num_workers', type=int, default=1, help='the number of training process')
    parser.add_argument('--num_classes', type=int, default=4, help='the classes of data')
