...
def parse_args():
    ...
    # basic parameters
    parser.add_argument('--model_name', type=str, default='DANN', help='the name of the model')
    ...
    parser.add_argument('--tradeoff', type=list, default=[1.], help='coefficient of loss')
