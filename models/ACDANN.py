...
Note: Augmented Conditional Domain Alignment Neural Network (ACDANN) is not named officially by the author.
'''
import torch
import logging
import numpy as np
...
class Trainset(InitTrain):
    ...
    def train(self):
        ...
        if args.train_mode == 'supervised':
            raise Exception("This model cannot be trained supervisedly.")
